...
saveRDS(object = iris_31, file = "data/iris_31.rds")
...
saveRDS(object = sir_31, file = "data/sir_31.rds")
...
saveRDS(object = osm_31, file = "data/osm_31.rds")
saveRDS(object = osm_tlse, file = "data/osm_tlse.rds")
saveRDS(object = osm, file = "data/osm.rds")

saveRDS(object = table_MAUP, file = "data/table_MAUP.rds")
