...
```{r, box.title=" Information", eval=TRUE, echo=TRUE, box.type = "advice"}
...
3. Simply use the "plot" instruction to plot the grid. Then, using the choroLayer function of the cartography package, plot the number of restaurants per kilometer in each box of the grid. What observation can you make concerning the readability of the map?
...
6. In order to make the result even more meaningful, we will now make a smoothed map. You can use the compute_kde function below. Use a 2km sigma and a 2km resolution and the quantile method (n = 12). 
