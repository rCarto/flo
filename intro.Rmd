...
# Introducing the R Spatial Ecosystem {.tabset}
...
Here we will focus on `cartography`. <small><small>Full disclosure: the speaker is the maintener of cartography.</small></small>

### Using `cartography` {.tabset}
...
# Grid map
grid <- getGridLayer(x = sm, cellsize = 3904*3904, 
...
smoothLayer(x = grid, var = "cad100", var2 = "act", 
            typefct = "exponential", 
            span = 3900, beta = 2, breaks = bks, col = cols,
...
### Dynamic/interactive maps  {.tabset}
