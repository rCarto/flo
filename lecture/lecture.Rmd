...
library(sf)
# Import geo layer
sm <- st_read(dsn = "../data/rhone/seine_maritime.geojson", stringsAsFactors = F, quiet=TRUE)
...
legendTypo(title.txt = "Dominant socio-professional Category", 
           col = c("#e3b4a2", "#a2d5d6", "#debbd4", "#b5dab6", "#afc2e3", "#e9e2c1"), 
...
These maps, as appealing as they seem to be, are not really suitable for displaying geostatistical information.
